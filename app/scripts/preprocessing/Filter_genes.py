...
class Filter_genes:
    ...
    @staticmethod
    def add_script(language: Language | str, min_cells: int, object: str = None):
        ...
        if language == Language.R or language == Language.R.value or language == Language.ALL_SUPPORTED:
            ...
            \npbmc <- CreateSeuratObject(counts = {object}, project = "pbmc3k", min.cells = {min_cells})
            """
        ...
        if language == Language.python or language == Language.python.value or language == Language.ALL_SUPPORTED:
            ...
            script = f"""
                \n# Filter cells \
                \nsc.pp.filter_genes(self.{object}, min_cells={min_cells})
            """
