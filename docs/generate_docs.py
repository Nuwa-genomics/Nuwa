                            ...
                            if docstring.meta[i].args[0] == 'notes':    
                                ...
                                for img in images:
                                    if img.__contains__("screenshot"):
                                        markdown += f"\n<img style='border-radius:10px; box-shadow: 5px 5px 10px rgb(0 0 0 / 0.5);' alt='page screenshot' src='{img.strip()}'>"
                        #methods
                        markdown += f"\n## Methods:\n\n{{% include list.liquid all=true %}}"
                        f.write(markdown)
                    ...
                    if ast.get_docstring(method):
                        ...
                        for i, example in enumerate(docstring.meta):
                            ...
                            if docstring.meta[i].args[0] == 'notes':    
                                ...
                                for img in images:
                                    if img.__contains__("screenshot"):
                                        markdown += f"\n<img style='border-radius:10px; box-shadow: 5px 5px 10px rgb(0 0 0 / 0.5);' alt='{method.name}_screenshot' src='{img.strip()}'>"
